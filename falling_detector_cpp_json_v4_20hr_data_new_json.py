...
class FrameLooper:
    ...
    def __init__(self, video_name, video_root):
        ...
        self.start_frame_index = 0 # 26140, 52703-30, 59737, 76794
    ...
    def run(self):
        ...
        for self.frame_index in range(len(self.cpp_json["outputs"])):
            ...
            # do stuff here
            if self.frame_index % 1440 == 0: print(self.frame_index, '-----------------')
...
if __name__ == "__main__":
    video_root = '/home/yazhini/dB/shared_videos/Kajima/20_hr/batch2_10_hr'
    video_name = '2021-10-15_16-00-00_no5_162637_slip'
